...
**Female anatomy inspection + split + batch optimization**: Female source inspected (2026-08-29) — 1073 nodes, 888 meshes, 92 materials, 5.47M vertices, 5.56M triangles, height 1.67m, ontology on 82.8% nodes. Detailed map in `docs/architecture/female-anatomy-map.md`. Split into 9 working system GLBs on 2026-08-29 via glTF-Transform 4.4.2 (`scripts/split-female.js`, preserved in `3d-assets/female/working/` — skin 17, musculoskeletal 107, nervous 362, cardiovascular 124, respiratory 70, digestive 61, urinary 87, reproductive 46, lymphatic 14; all 888 meshes/verts/tris preserved, see `docs/architecture/female-asset-split.md`). Batch Meshopt 4.4.2 on 2026-08-29: 9 optimized `*-meshopt.glb` in `3d-assets/female/working/optimized/` — skin 7.56 MB (84.3%), musculoskeletal 3.55 MB, cardiovascular 3.22 MB, respiratory 4.45 MB, digestive 1.34 MB, urinary 1.23 MB, reproductive 1.49 MB, lymphatic 1.14 MB, nervous 13.82 MB (80.1%); total 37.80 MB (81.3% saved), validated, see `docs/architecture/female-batch-optimization.md`.
