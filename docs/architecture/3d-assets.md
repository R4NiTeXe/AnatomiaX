...
**Female anatomy inspection + split**: Female source inspected (2026-08-29) — 1073 nodes, 888 meshes, 92 materials, 5.47M vertices, 5.56M triangles, height 1.67m, ontology on 82.8% nodes. Detailed map in `docs/architecture/female-anatomy-map.md`. Split into 9 working system GLBs on 2026-08-29 via glTF-Transform 4.4.2 (`scripts/split-female.js`, preserved in `3d-assets/female/working/` — skin 17 meshes, musculoskeletal 107, nervous 362, cardiovascular 124, respiratory 70, digestive 61, urinary 87, reproductive 46, lymphatic 14; all 888 meshes/verts/tris preserved, see `docs/architecture/female-asset-split.md`). Optimization has NOT yet been performed.
