/**
 * Minimal mobile API client — native fetch only, no Axios.
 * Consumes the standardized 8.19.25 error contract:
...
/** Prefer the contract body; fall back to raw text for legacy payloads. */
