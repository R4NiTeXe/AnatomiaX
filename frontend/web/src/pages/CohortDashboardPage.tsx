  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4" data-testid="dashboard-summary">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-xs uppercase tracking-widest text-slate-400">Best</CardTitle>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          ...
                          <span data-testid="dashboard-member-studied">{studiedCount} studied</span>{' '}
                          ·{' '}
                          <span data-testid="dashboard-member-quizzes">{totalQuizzes} quizzes</span>
                        </p>
                      </div>
