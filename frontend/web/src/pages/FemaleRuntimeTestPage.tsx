...
export default function FemaleRuntimeTestPage(): JSX.Element {
  ...
  return (
    <AnatomyStateProvider initialBodyModel="female">
      <main className="flex h-screen min-h-screen flex-col bg-slate-950 text-slate-100">
        <header className="border-b border-slate-900 px-4 py-3 sm:px-6">
          <p className="text-xs uppercase tracking-widest text-amber-500">
            Development test — female
          </p>
          <h1 className="mt-1 text-lg font-bold tracking-tight sm:text-xl">
            Female anatomy — runtime test
          </h1>
          <p className="mt-1 text-xs text-slate-500">
            Shared viewer with selectedBodyModel=female — not production
          </p>
        </header>
